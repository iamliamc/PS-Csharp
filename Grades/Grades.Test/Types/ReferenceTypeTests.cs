...
{   
    ...
    public class TypeTests
    {
        ...
        //** This test passes (because of C# passes by value)
        //** Since it's a value copy the 46 in X into number below, any 
        //**  changes happen to "number" only visible to the code inside IncrementNumber
